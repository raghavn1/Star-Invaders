...
public class TopDownShooter extends JPanel implements ActionListener, KeyListener, MouseListener, MouseMotionListener {
    ...
    private String SkinId = "/playerSprite.png";
    ...
    protected void paintComponent(Graphics g) {
        ...
        // g2d.drawImage(playerImg, (int)player.x, (int)player.y, GameConstants.PLAYER_SIZE, GameConstants.PLAYER_SIZE, null);
        ...
        g2d.drawImage(playerImg, 0, 0, 80, 80, null);
       ...
       // for (Zombie z : zombies) g2d.fillRect((int)z.x, (int)z.y, GameConstants.ZOMBIE_SIZE, GameConstants.ZOMBIE_SIZE);
        for (Zombie z : zombies) {
            g2d.drawImage(zombieImg, (int)z.x, (int)z.y, 50, 50, null);
        }
        ...
        // drawing ammunitions
        g2d.setColor(Color.BLUE);
        for(Ammunition a: ammunitions) g2d.drawImage(AmmoImg,(int)a.x, (int) a.y, GameConstants.AMMO_SIZE, GameConstants.AMMO_SIZE, null);
