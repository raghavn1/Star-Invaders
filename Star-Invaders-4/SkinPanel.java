//Class for the skin selection screen where players can pick their character look
...
public class SkinPanel extends JPanel{
    //Layout, button images, and the buttons for picking skins or going back
    ...
    //Constructor to set up the skin selection screen and button positions
    public SkinPanel(){

        this.setLayout(layout);
        this.setPreferredSize(new Dimension(800,600));

        //Positioning the skin buttons and the return button using spring layout
        ...
        //Setting up the normal border and the yellow hover highlight border
        Border normal = BorderFactory.createEmptyBorder(5, 5, 5, 5);
        Border hover = BorderFactory.createLineBorder(Color.YELLOW, 5);

        //Formatting skin 1 button and adding the hover effect logic
        ...
        Skin1.getModel().addChangeListener(e -> {
            if (Skin1.getModel().isRollover()) { //If it is rollover or hovering over it, add the hover border
        ...
        //Formatting skin 2 button and adding the hover effect logic
        ...
        //Formatting the return button and adding the hover effect logic
        ...
        //Adding the buttons to the panell so they appear
        this.add(Skin1);
        this.add(Skin2);
        this.add(returnButton);

        this.setBackground(new Color(44, 95, 52)); //Setting background to green
    }

    //Getters to give the Controller access to the buttons
